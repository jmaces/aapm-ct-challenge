...
from networks import DDNet, RadonNet
...
with open(
    ...
    for key, value in dd_net_params.items():
...
dd_net = DDNet(**dd_net_params).to(device)
...
for i in range(train_phases):
    ...
    logging = dd_net.train_on(train_data, val_data, **train_params_cur)
